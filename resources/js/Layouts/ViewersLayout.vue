            ...
            <nav ref="navBar" class="sticky top-0 z-40 bg-white border-b border-gray-100 transition-all duration-300">
                    ...
                    <div class="flex h-16 justify-between">
                        <div class="flex">
                            ...
                            <div class="flex shrink-0 items-center">
                                ...
                                <ApplicationLogo class="block h-9 w-auto fill-current text-gray-800 mr-20" />
                                </Link>
                            </div>
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavLink :href="route('about_sk')" :active="route().current('about_sk')">
                                    About
                                </NavLink>
                                <NavLink :href="route('programs_projects')"
                                    :active="route().current('programs_projects')">
                                    Projects
                                </NavLink>
                ...
                <div :class="{
                    ...
                    <div class="space-y-1 pb-3 pt-2">
                        ...
                        <ResponsiveNavLink :href="route('about_sk')" :active="route().current('about_sk')">
                            About
                        </ResponsiveNavLink>
                        <ResponsiveNavLink :href="route('programs_projects')"
                            :active="route().current('programs_projects')">
                            Projects
                        </ResponsiveNavLink>
            ...
            <div class="container mx-auto px-6 text-center">
                ...
                <div>
                    <ul class="flex justify-center mt-5 space-x-5">
                        <li>
                            <a class="text-gray-800 hover:text-gray-900 dark:hover:text-orange-600 dark:text-gray-600">
                                <svg aria-hidden="true" viewBox="0 0 24 24" fill="currentColor" class="w-8 h-8">
